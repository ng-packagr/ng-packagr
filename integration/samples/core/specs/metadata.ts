...
describe(`@sample/core`, () => {
  describe(`core.metadata.json`, () => {
    ...
    it(`should have "__symbolic": "reference" for 'peerDependencies' modules`, () => {
      ...
      const imported =
        METADATA['metadata']['AngularModule']['decorators'][0]['arguments'][0][
          'imports'
        ][0];
      ...
      const deps =
        METADATA['metadata']['AngularService']['members']['__ctor__'][0][
          'parameters'
        ][0];
