...
import { INIT_TS_CONFIG_TOKEN, INIT_TS_CONFIG_TRANSFORM } from './entry-point/init-tsconfig.di';
import { DEFAULT_OPTIONS_PROVIDER, OPTIONS_TOKEN } from './options.di';
import { packageTransformFactory } from './package.transform';

export const PACKAGE_TRANSFORM_TOKEN: InjectionToken<Transform> = new InjectionToken<Transform>(`ng.v5.packageTransform`);
